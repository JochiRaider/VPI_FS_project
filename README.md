...
This is the only non standard libary you need to use the software.
* GitHub3
  ```sh
...
1. Clone the repo
   ...
   ```
3. Setup a gist with a token base 64 encoded in the description 
...
5. Run the bootstrapper in your perferred python shell
